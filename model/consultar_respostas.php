...
$resposta = "SELECT id_pergunta, alternativa FROM resposta_equipe re inner join respostas r on (r.id_resposta = re.id_resposta) group by id_pergunta order by id_pergunta ";
